...
The table below lists every C# source file in `src/tsbindgen/` and the role it plays in
...
Autogenerated files under `src/tsbindgen/obj` are omitted from this list.  When adding new
