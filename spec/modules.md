...
The table below lists every C# source file in `src/generatedts/` and the role it plays in
...
| `Pipeline/DependencyTracker.cs` | Stores type → assembly mappings | `RecordTypeReference`, `ToJson` |
...
Autogenerated files under `src/generatedts/obj` are omitted from this list.  When adding new
