...
This directory documents every transformation performed by the `tsbindgen`
...
| [modules.md](modules.md) | One‑line responsibilities for every `.cs` file in `src/tsbindgen/` |
