...
public sealed class DeclarationRenderer
{
    ...
    public static string RenderIntrinsics()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("export {};  // Make this a module");
    ...
    public string RenderDeclarations(ProcessedAssembly assembly)
    {
        ...
        // Reference to shared intrinsics (branded types)
        sb.AppendLine("/// <reference path=\"./_intrinsics.d.ts\" />");
        sb.AppendLine();
